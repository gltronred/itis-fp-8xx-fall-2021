...
csvPars :: Parser [[String]]
csvPars = sepEndBy line (char '\n')
...
escKey:: Parser (Token String)
escKey = char '\\' >> anySingle

nCell :: Parser String
nCell = many (escKey <|> noneOf ",\n")

quo :: Parser String
quo = char '"' *> many (escKey <|> noneOf "\"") <* char '"'

main :: IO ()
main = do
  parseTest csvPars csv
