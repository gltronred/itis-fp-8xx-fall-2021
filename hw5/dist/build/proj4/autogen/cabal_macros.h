...
/* package proj4-0.1.0.0 */
#ifndef VERSION_proj4
#define VERSION_proj4 "0.1.0.0"
#endif /* VERSION_proj4 */
#ifndef MIN_VERSION_proj4
#define MIN_VERSION_proj4(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_proj4 */
...
/* package streaming-attoparsec-1.0.0.1 */
#ifndef VERSION_streaming_attoparsec
#define VERSION_streaming_attoparsec "1.0.0.1"
#endif /* VERSION_streaming_attoparsec */
#ifndef MIN_VERSION_streaming_attoparsec
#define MIN_VERSION_streaming_attoparsec(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_streaming_attoparsec */

/* package streaming-bytestring-0.2.1 */
#ifndef VERSION_streaming_bytestring
#define VERSION_streaming_bytestring "0.2.1"
...
#define CURRENT_COMPONENT_ID "proj4-0.1.0.0-7dp8yhYmEEsFKAepFv1tt0-proj4"
